...
const validationSchema = Yup.object().shape({
  ...
  github_token: Yup.string().matches(
    /^ghp_[a-zA-Z0-9]{36}$/,
    "Formato de token GitHub inválido (debe comenzar con ghp_ y tener 40 caracteres)"
  ),
});
      ...
      try {
        ...
        if (userResponse?.rol === "ESTUDIANTE") {
          try {
            ...
            // Asegurar que carrerasResponse sea un array
            const carrerasArray = Array.isArray(carrerasResponse) 
              ? carrerasResponse 
              : (carrerasResponse?.data && Array.isArray(carrerasResponse.data) 
                  ? carrerasResponse.data 
                  : []);
            setCarreras(carrerasArray);
          } catch (error) {
            console.error("Error cargando carreras:", error);
            setCarreras([]); // Fallback a array vacío
          }
        }
  ...
  const uploadDocuments = async () => {
    try {
      ...
      const necesitaMatricula =
        isEstudiante && !documentStatus.matricula_subida;
      ...
      if (hayCedulaNueva) formData.append("cedula", files.cedula_pdf);
      if (hayMatriculaNueva) formData.append("matricula", files.matricula_pdf);
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      const updateData = {
        ...
        id_car_per: values.id_car_per || null, // ✅ Agregar carrera
        github_token: values.github_token || null, // ✅ Agregar github_token
      };
                    ...
                    {userData?.fec_nac_usu && (
                      ...
                      >
                        ...
                        <Typography
                          ...
                          sx={{ fontSize: "0.9rem" }}
                        >
                          {new Date(userData.fec_nac_usu).toLocaleDateString(
                            "es-ES"
                          )}
                        </Typography>
                      </Box>
                    ...
                    {({
                      ...
                      <Form>
                          ...
                          <Grid container spacing={2}>
                            ...
                            <Grid xs={12} sm={6}>
                              <TextField
                                ...
                                disabled={!isEditing}
                                error={
                                  touched.fec_nac_usu && !!errors.fec_nac_usu
                                }
                                helperText={
                                  touched.fec_nac_usu && errors.fec_nac_usu
                                }
                            ...
                            <Grid xs={12} sm={6}>
                              <TextField
                                ...
                                disabled={!isEditing}
                                error={
                                  touched.num_tel_usu && !!errors.num_tel_usu
                                }
                                helperText={
                                  touched.num_tel_usu && errors.num_tel_usu
                                }
                        ...
                        >
                          <Typography
                            variant="h6"
                            sx={{ fontWeight: 600, mb: 2, color: "#757575" }}
                          >
                ...
                >
                  ...
                  {documentStatus.documentos_verificados ? (
                    <Typography variant="body2">
                      Tus documentos han sido verificados por un administrador.
                      ¡Ya puedes inscribirte en eventos y cursos!
                    ...
                    <Typography variant="body2">
                      ...
                      administrador. Una vez verificados, podrás inscribirte en
                      eventos y cursos.
                      ...
                      {documentStatus?.cedula_subida && (
                        <CardActions>
                          <Button
                            ...
                            disabled={
                              deleting || documentStatus?.documentos_verificados
                            }
                            sx={{
                              display: documentStatus?.documentos_verificados
                                ? "none"
                                : "inline-flex",
                            }}
                          >
                          ...
                          {documentStatus?.matricula_subida ? (
                            ...
                            <Box>
                              ...
                              <input
                                ...
                                type="file"
                                onChange={(e) =>
                                  handleFileSelect(e, "matricula_pdf")
                                }
                              />
