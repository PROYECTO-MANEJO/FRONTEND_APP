  ...
  const handleGuardarBorrador = async () => {
    try {
      ...
      if (modoEdicion) {
        ...
        navigate(`/admin/mis-solicitudes/editar/${response.data.id_sol}`);
      }
      ...
      >
        ...
        <Box sx={{ mb: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
            ...
            <Typography variant="h4" component="h1" sx={{ fontWeight: 'bold', color: '#6d1313' }}>
...
export default AdminCrearSolicitud; 